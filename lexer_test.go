...
func TestTokenize_Types(t *testing.T) {
	...
	tests := []struct {
		...
		{"float", "3.141", []tokenType{tokFloat, tokEOF}},
		{"trailing dot with no digit stays an int", "3.", []tokenType{tokInt, tokDot, tokEOF}},
		{"plus", "+", []tokenType{tokPlus, tokEOF}},
		{"string concatenation", `"a" + "b"`, []tokenType{tokString, tokPlus, tokString, tokEOF}},
